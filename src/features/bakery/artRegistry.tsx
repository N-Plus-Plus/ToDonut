...
const navigationKeys = ["bakery-pantry", "bakery-kitchen", "bakery-display", "bakery-business", "bakery-storefront"] as const;
const businessKeys = [
...
export function BakeryArt({ assetKey, label }: { assetKey: string; label?: string }) {
  const src = paths[expectedBakeryArtPath(assetKey)];
