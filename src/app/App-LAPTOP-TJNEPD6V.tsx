...
export function CardActionMenu({ label, actions }: { label: string; actions: CardActionMenuItem[] }) {
  ...
  return (
    <div className="card-action-menu card-action-menu--mobile">
      <button
        ref={triggerRef}
        type="button"
        className={`icon-button button ghost card-action-menu__trigger ${open ? "selected" : ""}`}
        aria-label={label}
        aria-haspopup="menu"
        aria-expanded={open}
        title="Actions"
      ...
      {open && (
        <AnchoredOverlay
          ...
          className="card-action-menu__panel"
          placement="left"
          ...
          <div className="card-action-menu__items" role="menu" aria-label={label}>
            {actions.map((action) => (
              <button
                ...
                type="button"
                role="menuitem"
                className={`card-action-menu__item button ghost ${action.danger ? "danger" : ""}`}
                onClick={() => {
                  setOpen(false);
                  action.onSelect();
                }}
...
export function AreaRow({
  ...
  return (
    ...
    >
      ...
      <CardActionMenu
        label={`Open actions for ${area.title}`}
        actions={[
